...
@Component({
  selector: 'app-lista-duplamente-insere-fim',
  imports: [TranslateModule, CommonModule, RouterModule],
  templateUrl: './lista-duplamente-insere-fim.component.html',
  styleUrl: './lista-duplamente-insere-fim.component.scss'
})
export class ListaDuplamenteInsereFimComponent {
  tituloPag = 'DOUBLY_LINKED_LIST.TITLE';
  ...
  listaInsere = './printListas/ListaEncadeada_inicio/listaDuplamenteInsere.png';
  listaMostraEspecifico = './printListas/ListaEncadeada_inicio/listaDuplamentoMostraEspecifico.png';
  listaRemover = './printListas/ListaEncadeada_inicio/listaDuplamenteRemove.png';
  listaCodigoInsereInicio = './printListas/ListaEncadeada_inicio/listaDuplamenteCodigoInsereFim.png';
  listaCodigoRemoveInicio = './printListas/ListaEncadeada_inicio/listaDuplamenteCodigoRemoveFim.png';
  ...
  atualizarMemoriaSimulada() {
    ...
    while (atual !== null) {
      const dadosNo = {
        ...
        info: atual.next === null ? 'DOUBLY_LINKED_LIST_ORDENATE.MODAL.VALUE' : '',
